...
Implementation commit: `8b9d763`; lifecycle hardening: `fe6beb4`; pause-clock evidence refinement: `2ead0c5`.
...
- `GODOT_BIN=... scripts/run_gut_tests.sh`: 10 scripts, 56 tests, 248 assertions pass.
- `GODOT_BIN=... scripts/run_gut_tests.sh --recovery-mode`: 10 scripts, 56 tests, 248 assertions pass.
- `GODOT_BIN=... scripts/run_headed_acceptance.sh --xvfb`: pass; headed evidence covers route discovery, takeoff-gated timing, finish state, Retry, pause/resume, Change Map, respawn, and Exit.
...
The headed run also captures `build/headed/06_finish.png`, showing the completed-trial result panel with Retry, Change Map, and Exit actions.

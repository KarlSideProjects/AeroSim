...
func test_demo_panel_split_places_a_portrait_panel_left_of_an_equal_height_game() -> void:
    var split := GspLauncher.demo_panel_split(Vector2i(100, 50), Vector2i(1920, 900))

    assert_eq(split.game_position, Vector2i(606, 50))
    assert_eq(split.game_size, Vector2i(1414, 900))
    assert_eq(split.panel_position, Vector2i(100, 50))
    assert_eq(split.panel_size, Vector2i(506, 900))
